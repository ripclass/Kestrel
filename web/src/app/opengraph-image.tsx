...
export const alt = "Kestrel — Financial crime intelligence for Bangladesh";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

// Open Graph card for LinkedIn / Slack / Teams / X link unfurls.
// Slate background, centered lockup, mono tagline strip at bottom, vermillion
// ┼ signature top-left. Served from `/opengraph-image` automatically by
// Next.js App Router — no metadata config needed.
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* center block — mark + wordmark stacked */}
        <div
          style={{
            flex: 1,
            display: "flex",
        ...
        <div
          style={{
            borderTop: "1px solid rgba(234, 230, 218, 0.10)",
            padding: "28px 72px",
            display: "flex",
            alignItems: "center",
        ...
        >
          <div style={{ display: "flex" }}>Financial Crime Intelligence</div>
          <div style={{ display: "flex" }}>Built in Bangladesh</div>
        </div>
      </div>
    ),
    size,
