...
const navItems: NavItem[] = [
  ...
  { section: "Intelligence Tools", label: "TBML", href: "/intelligence/tbml", aka: "Trade-based ML coverage — BFIU TBML Guidelines 2019" },
  ...
  { section: "Operations", label: "Screening", href: "/screen", aka: "Sanctions / PEP / adverse-media screening (Kestrel-native)" },
  { section: "Operations", label: "Customers", href: "/customers", personas: ["bank_camlco"], aka: "KYC / CDD onboarding (Kestrel-native)" },
