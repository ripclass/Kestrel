...
### 6.1 Production tenants on prod database `bmlyqlkzeuoglyvfythg`
...
```sql
SELECT set_config('request.jwt.claim.sub','2116c2a3-30fa-4bf0-8d82-ab2b7f1ac946',true);
...
| Subject UUID | `auth_org_id()` | `is_regulator()` |
| --- | --- | --- |
| Sonali CAMLCO `2116c2a3-…ab2b7f1ac946` | `9c222222-…222222222222` | `false` |
| BFIU director `5ce69ed6-…a9581712c091` | `9c111111-…111111111111` | `true` |
| BFIU analyst `7ddaacd6-…1821ddaeedbf` | `9c111111-…111111111111` | `true` |
| Synthetic unknown `00000000-…000000000000` | `null` | `false` |
...
Authenticated to `https://kestrel-nine.vercel.app` as
`camlco@kestrel-sonali.test` and navigated to each surface.
