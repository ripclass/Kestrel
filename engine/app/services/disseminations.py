...
def _serialize_summary(record: Dissemination, org_name: str) -> DisseminationSummary:
    return DisseminationSummary(
        ...
        recipient_authority=record.recipient_authority,
        mlpa_section=record.mlpa_section,
        circular_22_exchange=bool(record.circular_22_exchange),
        predicate_offences=list(record.predicate_offences or []),
...
async def create_dissemination(
    ...
    *,
    ...
    record = Dissemination(
        ...
        recipient_authority=payload.recipient_authority,
        mlpa_section=payload.mlpa_section,
        circular_22_exchange=bool(payload.circular_22_exchange),
        predicate_offences=list(payload.predicate_offences or []),
